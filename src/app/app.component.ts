...
export class AppComponent {
  ...
  init() {
    ...
    var PosMount = Cesium.Cartesian3.fromDegrees(86.9250, 27.9878, 500);
    ...
    var tcontroller = new TController();
    tcontroller.setPosition(PosMount);
    tcontroller.setDirection(Cesium.Cartesian3.fromElements(1.0, 0.0, 0.0));
  ...
  //  this.addAppEntityToManager({ _name: "AircraftKolkata", _position: PosMumbai, _modelUrl: modelAircraft, _Controller: fwdcontroller });
    this.addAppEntityToManager({ _name: "AircraftKolkata", _position: PosMount, _modelUrl: modelAircraft, _Controller: tcontroller });
